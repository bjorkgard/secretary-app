  ...
  <div>
    ...
    <input
      ...
      :class="[
        ...
        'block w-full rounded-md border mt-1 py-2 px-3 leading-5 focus:border-sky-500 focus:placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm dark:placeholder-slate-400 dark:focus:border-slate-400 dark:focus:bg-slate-400 dark:focus:text-slate-900 dark:focus:ring-transparent'
      ]"
